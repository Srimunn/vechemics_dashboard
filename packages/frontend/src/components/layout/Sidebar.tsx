    ...
    return (
      <Link
        ...
        className={cn(
          ...
          isIndented && 'ml-3 pl-3 border-l border-slate-200/80',
          active
    ...
    <div className="flex h-full flex-col bg-[#FFFFFF] text-[#475569] select-none">
          ...
          return (
            <div key={group.label} className="space-y-1">
              <button
                ...
                className={cn(
                  'w-full flex items-center justify-between px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider transition-colors rounded-md',
      ...
      <div className="border-t border-[#E2E8F0] px-3 pt-2 pb-3 shrink-0 bg-white">
        ...
        <div className="flex items-center px-3 pt-2 text-[11px] text-[#94A3B8] border-t border-slate-100">
          ...
          <span className="truncate">Tally sync • TallyPrime Release 7.0</span>
        </div>
      </div>
    </div>
  );
